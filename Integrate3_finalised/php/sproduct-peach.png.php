...
<head>
    ...
    <title>Nagano Beni Banka Peach</title>
    ...
    <section class="sproduct">
        <div class="row">
            <div class="product-column">
                <img src="../images/fruits/peach.png" alt="" name="product_image">            
            </div>
            <?php
                $select_products = mysqli_query($conn_user, "SELECT * FROM `products` WHERE image = 'peach.png'");
                if (mysqli_num_rows($select_products) > 0) {
                    $fetch_product = mysqli_fetch_assoc($select_products); // Retrieve the peach product
                ?>
                <div class="description-column">
                    ...
                    <ul class="fruits-description">
                        <li>The "Beni Banka" peach is a late-maturing variety cultivated in Suzaka City, Nagano Prefecture</li>
                        <li>The fruit has a flattened round shape, with a size of around 400g.</li>
                        <li>The peach has a sugar content (Brix) of around 9-15%, <br />and the acidity of the juice has a pH of about 4.5.</li>
                        <li>Processed in Nagano</li>
                        <li><b>Storage directions</b>: Store in cool dry area at room temperature.</li>
                    </ul>
