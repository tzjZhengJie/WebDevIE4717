...
<head>
    ...
    <title>Fuyu Gaki Persimmon (4pcs)</title>
    ...
    <section class="sproduct">
        <div class="row">
            <div class="product-column">
                <img src="../images/fruits/persimmon.png" alt="" name="product_image">            
            </div>
            <?php
                $select_products = mysqli_query($conn_user, "SELECT * FROM `products` WHERE image = 'persimmon.png'");
                if (mysqli_num_rows($select_products) > 0) {
                    $fetch_product = mysqli_fetch_assoc($select_products); // Retrieve the persimmon product
                ?>
                <div class="description-column">
                    ...
                    <ul class="fruits-description">
                        <li>King of all sweet persimmons</li>
                        <li>Soft texture</li>
                        <li>Contains Vitamin C (2 times more than mandarin).</li>
                        <li>Processed in Fukuoka or Yamanashi</li>
                        <li><b>Storage direction</b>: Avoid direct sunlight/ places with high heat and humidity.</li>
                    </ul>
