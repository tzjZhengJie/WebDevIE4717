    ...
    <section class="sproduct">
        <div class="row">
            <div class="product-column">
                <img src="../images/fruits/melon.png" alt="" name="product_image">            
            </div>
            <?php
                $select_products = mysqli_query($conn_user, "SELECT * FROM `products` WHERE image = 'melon.png'");
                if (mysqli_num_rows($select_products) > 0) {
                    $fetch_product = mysqli_fetch_assoc($select_products); // Retrieve the melon product
                ?>
                <div class="description-column">
                    ...
                    <ul class="fruits-description">
                        <li>Unparalleled sweetness and rich flavor profile.</li>
                        <li>Exclusively grown in the Yubari region of Japan</li>
