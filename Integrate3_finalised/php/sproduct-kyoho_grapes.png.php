...
<head>
    ...
    <title>Nagano Seedless Kyoho (500g)</title>
    ...
    <section class="sproduct">
        <div class="row">
            <div class="product-column">
                <img src="../images/fruits/kyoho_grapes.png" alt="" name="product_image">            
            </div>
            <?php
                $select_products = mysqli_query($conn_user, "SELECT * FROM `products` WHERE image = 'kyoho_grapes.png'");
                if (mysqli_num_rows($select_products) > 0) {
                    $fetch_product = mysqli_fetch_assoc($select_products); // Retrieve the kyoho_grapes product
                ?>
                <div class="description-column">
                    ...
                    <ul class="fruits-description">
                        <li>Highest production volume</li>
                        <li><b>Seed</b>: No</li>
                        <li><b>Peel Edible</b>: No</li>
                        <li><b>Characteristics</b>: King of Japanese Grapes, Strong Sweetness</li>
                        <li>Consume within 3 - 7 days from when you received the item.</li>
                        <li><b>Storage directions</b>: Store in organic space or chilled space of your refrigerator.</li>
                    </ul>
