...
<head>
    ...
    <title>Yamakita Mandarin Mikan (500g)</title>
    ...
    <section class="sproduct">
        <div class="row">
            <div class="product-column">
                <img src="../images/fruits/orange.png" alt="" name="product_image">            
            </div>
            <?php
                $select_products = mysqli_query($conn_user, "SELECT * FROM `products` WHERE image = 'orange.png'");
                if (mysqli_num_rows($select_products) > 0) {
                    $fetch_product = mysqli_fetch_assoc($select_products); // Retrieve the orange product
                ?>
                <div class="description-column">
                    ...
                    <ul class="fruits-description">
                        <li>This mandarin has the perfect balance of sweetness and sourness.</li>
                        <li>Yamakita's mandarin hill is well exposed to the southern sun, <br />allowing the flesh to grown juicy and sweet.</li>
                        <li>Processed in Kochi</li>
                    </ul>
