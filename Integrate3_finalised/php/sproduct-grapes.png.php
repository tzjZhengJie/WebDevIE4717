...
<head>
    ...
    <title>Nagano Shine Muscat (500g)</title>
    ...
    <section class="sproduct">
        <div class="row">
            <div class="product-column">
                <img src="../images/fruits/grapes.png" alt="" name="product_image">            
            </div>
            <?php
                $select_products = mysqli_query($conn_user, "SELECT * FROM `products` WHERE image = 'grapes.png'");
                if (mysqli_num_rows($select_products) > 0) {
                    $fetch_product = mysqli_fetch_assoc($select_products); // Retrieve the grapes product
                ?>
                <div class="description-column">
                    ...
                    <ul class="fruits-description">
                        <li><b>Seed</b>: No</li>
                        <li><b>Peel Edible</b>: Yes</li>
                        <li><b>Characteristics</b>: Produced only in Nagano, Big Flesh</li>
