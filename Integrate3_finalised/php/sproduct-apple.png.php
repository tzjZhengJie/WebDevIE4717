...
<head>
    ...
    <title>Aomori Fuji Apple (10pcs)</title>
    ...
    <section class="sproduct">
        <div class="row">
            <div class="product-column">
                <img src="../images/fruits/apple.png" alt="" name="product_image">            
            </div>
            <?php
                $select_products = mysqli_query($conn_user, "SELECT * FROM `products` WHERE image = 'apple.png'");
                if (mysqli_num_rows($select_products) > 0) {
                    $fetch_product = mysqli_fetch_assoc($select_products); // Retrieve the apple product
                ?>
                <div class="description-column">
                    ...
                    <ul class="fruits-description">
                        <li>Fuji apples are renowned for their irresistible sweetness and crisp, juicy texture.</li>
                        <li>Fuji apples are rich in fiber, vitamins, and antioxidants.</li>
                        <li>Processed in Aomori</li>
                        <li><b>Storage directions</b>: Avoid direct sunlight / places with high heat and humidity.</li>
                    </ul>
