...
<head>
    ...
    <title>Hakata Amaou Strawberry (270g)</title>
    ...
    <section class="sproduct">
        <div class="row">
            <div class="product-column">
                <img src="../images/fruits/strawberry.png" alt="" name="product_image">            
            </div>
            <?php
                $select_products = mysqli_query($conn_user, "SELECT * FROM `products` WHERE image = 'strawberry.png'");
                if (mysqli_num_rows($select_products) > 0) {
                    $fetch_product = mysqli_fetch_assoc($select_products); // Retrieve the strawberry product
                ?>
                <div class="description-column">
                    ...
                    <ul class="fruits-description">
                        <li>Amaou stands for "赤い・丸い・大きい・美味い" (Red, Round, Big, and Delicious).</li>
                        <li>Registered as the heaviest strawberry in the world by Guiness Record.</li>
                        <li>Processed in Fukuoka</li>
                        <li>Enjoy within 3 - 5 days for the best taste and quality.</li>
                        <li><b>Storage directions</b>: Store it in the refrigerator to maintain its freshness and sweetness.</li>
                    </ul>
